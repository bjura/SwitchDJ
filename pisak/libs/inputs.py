...
"""
Specification of all the avalaible PISAK input modes.
"""
INPUTS = {
    "mouse": {
        "process": None,
...
class InputGroup(object):
    ...
    def __init__(self, stage):
        ...
        try:
            ...
            msg = "Missing a key from default config - PISAK deafult config file may be corrupted."
    ...
    def get_scanning_desc(self, scanning_group):
        """
        Get description of things neccessary for activating the scanning group.
    ...
    def launch_sprite(self):
        ...
        if self.sprite is None:
            self.sprite = cursor.Sprite(self.content)
            _LOG.debug("Running sprite...")
            self.content.insert_child_above(self.sprite, None)
        else:
    ...
    def stop_sprite(self):
        ...
        """
        if self.sprite:
            self.content.remove_child(self.sprite)
            self.sprite = None
        else:
    ...
    def run_middleware(self):
        ...
        if self.content is None:
            ...
            if self.activator:
                if self.content.get_property("mapped"):
                    self.activator(self)
                else:
...
def run_input_process():
    ...
    :returns: process of the input or None
    """
